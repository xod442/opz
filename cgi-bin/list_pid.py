...
#  Calls glarn chooser and shows list of dpids
#  
#
...
print "</head>"
print "<body>"
print "<FORM method='post' ACTION=\"./list2_pid.py\">"
print "<h1> <img src=\"../../images/glarn.png\" width=\"50\" height=\"50\">glarn: The dpid database</h1>" 
print "<HR> "
print "<h3> This is a list of dpids in glarn. select the items to be displayed<br>"
...
print "<input type=\"submit\" style=\"font-face: 'Arial'; font-size: larger; color: black; background-color: #0066FF; border: 3pt ridge lightgrey\" value=\" List dpid\">"
print "<hr>"
