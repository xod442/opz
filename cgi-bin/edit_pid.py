...
#  Calls glarn chooser and edits selected entrie....ONLY one at a time!
#  
#
...
print "</head>"
print "<body>"
print "<FORM method='post' ACTION=\"./edit2_pid.py\">"
print "<h1> <img src=\"../../images/glarn.png\" width=\"50\" height=\"50\">glarn: The dpid database</h1>" 
print "<HR> "
print "<h3> This is a list of dpids in glarn. select the item to be Deleted<br>"
print "<select name=\"list_o_pids\" size=\"10\">"
for row in gcur.execute("SELECT * FROM dpid WHERE sel ='%s'" % sel):
   dpid = row[0]
   print "<option value = \"%s\"> %s </option>" % (dpid,dpid)
print "</select>"
print "<br>"
print "Select a single dpid for editing<br>"
#print "<h3>%s record(s) have been automatically written to the glarn database...information was retrieved from IMC</h3>" % (c)
print "<input type=\"submit\" style=\"font-face: 'Arial'; font-size: larger; color: black; background-color: #0066FF; border: 3pt ridge lightgrey\" value=\" Edit dpid\">"
print "<hr>"
